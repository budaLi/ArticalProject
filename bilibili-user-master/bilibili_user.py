...
proxies = {
    'https': 'https://182.45.178.61:6666',
    'https': 'https://125.111.118.69:21858',
    'https': 'https://49.82.54.177:40146',
}
time1 = time.time()
            ...
            if statusJson == True:
                ...
                try:
                    ...
                    conn = pymysql.connect(
                        host='localhost', user='root', passwd='123', db='bilibili_user_info', charset='utf8')
                    cur = conn.cursor()
